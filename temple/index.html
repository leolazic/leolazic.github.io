...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <div class="container" style="position: relative;">
      <div id="leftcol" style="position: static;">
        <p class="pos_fixed">
        <a class='menulink' href='note.php'>note</a>
        <br>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <span style="color:#FFFFFF; text-decoration: none; font-style:italic padding-left:400px">&copy; Leo Lazic 2001</span>
        <br>
